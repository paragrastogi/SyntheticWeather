	...
	python indra.py --train 1 --station_code 'gen' --n_samples $n_samples --path_file_in 'gen/che_geneva.iwec.a' --path_file_out 'gen/gen_iwec_syn.a' --file_type 'espr' --store_path 'gen' --arma_params 4,4,1,1,24
